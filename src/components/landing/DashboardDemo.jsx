...
export default function DashboardDemo({ onStart }) {
    ...
    return <section className="cg-section cg-dashboard-section" id="dashboard">
        <div className="cg-shell"><div className="cg-section-head cg-section-head-wide"><div><span className="cg-kicker"><i />The product</span><h2>Your search,<br /><em>at a glance.</em></h2></div><p>Switch views inside the demo. Your roles, interviews and next steps stay connected.</p></div>
