...
export default function InterviewPrepSection({ onStart }) {
    ...
    return <section className="cg-section cg-prep" id="interview-prep" ref={ref}><div className="cg-shell"><div className="cg-section-head cg-section-head-dark"><div><span className="cg-kicker cg-kicker-light"><i />Step 05 · Prepare together</span><h2>Everything for this<br /><em>interview, in one room.</em></h2></div><p>Company research, role requirements, your notes and every practice round stay connected to the job.</p></div>
